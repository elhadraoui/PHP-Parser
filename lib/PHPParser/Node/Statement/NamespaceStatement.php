 ...
 */
class Statement_Namespace extends Statement
{
     ...
     */
    public function __construct(Name $name = null, $Statements = array(), array $attributes = array()) {
        parent::__construct(
            array(
                'name'  => $name,
        ...
        if (null !== $this->Statements) {
            foreach ($this->Statements as $Statement) {
                if ($Statement instanceof Statement_Namespace) {
    ...
    public static function postprocess(array $Statements) {
        ...
        foreach ($Statements as $i => $Statement) {
            ...
            } elseif (!$Statement instanceof Statement_Declare
        ...
        // for semicolon style transplant statements
            ...
            for ($i = 0, $c = count($nsOffsets); $i < $c; ++$i) {
                ...
                if ($c === $i + 1) {
                    ...
                    if (end($nsStatement->Statements) instanceof HaltCompiler) {
